  ...
  return (
    <section className="relative bg-background overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 py-16 md:py-24 text-center">
        ...
        <p className="mt-4 text-xl md:text-2xl lg:text-3xl text-text-secondary max-w-2xl mx-auto opacity-0 animate-fade-in-up animation-delay-100">
          {subtitle}
        </p>

        {/* CTA Links */}
        <div className="mt-6 flex justify-center gap-6 opacity-0 animate-fade-in-up animation-delay-200">
          <Link
        ...
        {/* Hero Image */}
        <div className="mt-10 md:mt-16 opacity-0 animate-scale-in animation-delay-300">
          <img
            src={image}
            alt={title}
